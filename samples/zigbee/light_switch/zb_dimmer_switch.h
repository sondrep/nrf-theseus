 ...
 */
#define ZB_ZCL_DECLARE_DIMMER_SWITCH_SIMPLE_DESC(ep_name, ep_id, in_clust_num, out_clust_num)      \
...
#define ZB_DECLARE_DIMMER_SWITCH_EP(ep_name, ep_id, cluster_list)                                  \
	ZB_ZCL_DECLARE_DIMMER_SWITCH_SIMPLE_DESC(ep_name, ep_id, ZB_DIMMER_SWITCH_IN_CLUSTER_NUM,  \
						 ZB_DIMMER_SWITCH_OUT_CLUSTER_NUM);                \
                                                                                                   \
	ZB_AF_DECLARE_ENDPOINT_DESC(                                                               \
		ep_name, ep_id, ZB_AF_HA_PROFILE_ID, 0, NULL,                                      \
		ZB_ZCL_ARRAY_SIZE(cluster_list, zb_zcl_cluster_desc_t), cluster_list,              \
		(zb_af_simple_desc_1_1_t *)&simple_desc_##ep_name, 0, NULL, /* No reporting ctx */ \
		0, NULL)						    /* No CVC ctx */
