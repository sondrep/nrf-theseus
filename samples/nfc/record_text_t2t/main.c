...
int main(void)
{
	...
	LOG("[INFO] NFC Text record for Type 2 Tag sample started");
	...
	if (nfc_t2t_setup(nfc_callback, NULL) < 0) {
		LOG("[ERROR] Cannot setup NFC T2T library!");
		goto fail;
	}
	...
	LOG("[INFO] NFC Text record for Type 2 Tag sample initialized");
