...
static int gppi_init(void)
{
	...
	nrfx_gppi_channel_init(NRFX_GPPI_NODE_DPPIC00, NRFX_BIT_MASK(DPPIC00_CH_NUM_SIZE) & ~1);
	nrfx_gppi_channel_init(NRFX_GPPI_NODE_DPPIC10, NRFX_BIT_MASK(DPPIC10_CH_NUM_SIZE) & ~1);
	nrfx_gppi_channel_init(NRFX_GPPI_NODE_DPPIC20, NRFX_BIT_MASK(DPPIC20_CH_NUM_SIZE) & ~1);
	nrfx_gppi_channel_init(NRFX_GPPI_NODE_DPPIC30, NRFX_BIT_MASK(DPPIC30_CH_NUM_SIZE) & ~1);
	...
	nrfx_gppi_groups_init(NRFX_GPPI_NODE_DPPIC00, NRFX_BIT_MASK(DPPIC00_GROUP_NUM_SIZE) & ~1);
	nrfx_gppi_groups_init(NRFX_GPPI_NODE_DPPIC10, NRFX_BIT_MASK(DPPIC10_GROUP_NUM_SIZE) & ~1);
	nrfx_gppi_groups_init(NRFX_GPPI_NODE_DPPIC20, NRFX_BIT_MASK(DPPIC20_GROUP_NUM_SIZE) & ~1);
	nrfx_gppi_groups_init(NRFX_GPPI_NODE_DPPIC30, NRFX_BIT_MASK(DPPIC30_GROUP_NUM_SIZE) & ~1);
#elif defined(CONFIG_NRFX_GPPI_SD2PPI_GLOBAL)
	gppi_instance.routes = nrfx_gppi_routes_get();
	gppi_instance.route_map = nrfx_gppi_route_map_get();
	gppi_instance.nodes = nrfx_gppi_nodes_get();
	...
	nrfx_gppi_channel_init(NRFX_GPPI_NODE_DPPIC020, NRFX_BIT_MASK(DPPIC020_CH_NUM_SIZE) & ~1);
	nrfx_gppi_channel_init(NRFX_GPPI_NODE_DPPIC030, NRFX_BIT_MASK(DPPIC030_CH_NUM_SIZE) & ~1);
	nrfx_gppi_channel_init(NRFX_GPPI_NODE_PPIB020_030,
			       NRFX_BIT_MASK(PPIB020_NTASKSEVENTS_SIZE));
	nrfx_gppi_groups_init(NRFX_GPPI_NODE_DPPIC020, NRFX_BIT_MASK(DPPIC020_GROUP_NUM_SIZE) & ~1);
	nrfx_gppi_groups_init(NRFX_GPPI_NODE_DPPIC030, NRFX_BIT_MASK(DPPIC030_GROUP_NUM_SIZE) & ~1);
#else
#error "Not supported"
#endif
...
THESEUS_MODULE_SET(gppi) = {.init = gppi_init, .stage = THESEUS_MODULE_STAGE_EARLY};
